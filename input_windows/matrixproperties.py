...
from tkinter             import Frame, Label, Entry, OptionMenu, Button, Text, DoubleVar, StringVar, IntVar, messagebox 
...
class MatrixProperties:
    ...
    def warning(self):
        ...
        messagebox.showerror(title = self.version, message = 'No matrices has been selected, please add matrices by pressing the button "Add materials" or the button "Add mixture"')
