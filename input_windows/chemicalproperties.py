...
class ChemicalProperties:
    ...
    def make_widgets(self):
        ...
        self.tempunits    = Label(self.tframe,  text = chr(176) + 'C')
    ...
    def warning(self):
        ...
        messagebox.showerror(title = self.version, message = 'No chemical has been selected, please add chemicals by pressing the button "Add chemicals"')
