...
from tkinter             import Frame, Label, Entry, OptionMenu, Button, Text, \
                                DoubleVar, StringVar, IntVar, messagebox, font
...
class ChemicalEditor:
    ...
    def make_widgets(self):
        ...
        self.tempunits    = Label(self.frame,  text = chr(176) + 'C')
    ...
    def chemicals_error(self):
        ...
        messagebox.showerror(title = self.version, message = 'This chemical has already been selected!')
        self.focusbutton = self.okbutton
        self.master.tk.lift()

    def name_error(self):

        messagebox.showerror(title = self.version, message = 'Please input the name for the chemical!')
        self.focusbutton = self.okbutton
        self.master.tk.lift()

    def Dw_error(self):

        messagebox.showerror(title = self.version, message = 'The diffusivity of the chemical can not be zero, please correct!')
        self.focusbutton = self.okbutton
        self.master.tk.lift()
...
class ChemicalImporter:
    ...
    def __init__(self, master, system, database):
        ...
        self.chemicals_list = sorted(self.chemicals_list)
