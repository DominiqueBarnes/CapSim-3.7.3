...
import matplotlib.pyplot as plt, math, sys, os, codecs, csv, winreg as wreg
...
class Graphprocess:
    ...
    def importdata(self, event = None):
        ...
        self.dataname = filedialog.askopenfilename(initialdir = Filepath +r'\output',  filetypes = [('Output files','*.csv')])
        if self.dataname != '':
    ...
    def show_error(self, event = None):
        ...
        messagebox.showerror(title = 'Run Error', message = 'Unable to process the file')
