...
from tkinter             import Frame, Label, Entry, OptionMenu, Button, Text, StringVar, DoubleVar, IntVar, Tk, messagebox, filedialog
...
def make_database(path):
    ...
    pickle.dump(chemicaldatabase, open(path + r'/database/capsim3_chemicaldatabase', 'wb'))
    
    return open(path + r'/database/capsim3_chemicaldatabase', 'rb')
